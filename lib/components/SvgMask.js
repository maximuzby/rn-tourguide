...
const FIRST_PATH = `M0,0H${screenDimensions.width}V${screenDimensions.height}H0V0ZM${screenDimensions.width / 2},${screenDimensions.height / 2 + 100} h 1 v 1 h -1 Z`;
    ...
    class SvgMask extends Component {
        ...
        render() {
            ...
            return (React.createElement(View, { style: this.props.style, onLayout: this.handleLayout, pointerEvents: 'none' },
                React.createElement(Svg, { pointerEvents: 'none', width: this.state.canvasSize.x, height: this.state.canvasSize.y + 100 },
